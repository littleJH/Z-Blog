...
const validateNewPass = (_: any, value: any, callback: any) => {
  if (value === '') {
    ...
    if (findPassForm.form2.checkPass !== '') {
      ...
      findRuleFormRef.value.validateField('checkPass', () => null)
    }
    callback()
  }
}
...
<template>
  ...
  >
    <div
      ...
      class="w-full h-full fixed flex justify-center top-0 items-center z-30"
    >
      <div
        v-if="showDialog.step1"
        class="flex flex-col justify-center items-center bg-blue-200 bg-opacity-50 shadow-2xl dark:bg-opacity-30 dark:text-white"
      ...
      >
        ...
        <div class="px-4 py-2 w-full">
          ...
          >
            <el-form-item prop="email">
              <el-input
                v-model="findPassForm.form1.email"
                placeholder="邮箱"
              ></el-input>
            </el-form-item>
            <el-form-item>
              <el-input
                v-model="findPassForm.form1.verify"
                placeholder="验证码"
              ></el-input>
            </el-form-item>
          </el-form>
      ...
      <div
        v-if="showDialog.step2"
        class="flex flex-col justify-center bg-blue-200 bg-opacity-50 shadow-2xl dark:bg-opacity-30 dark:text-white"
        style="width: 300px; height: 300px"
      >
        <p class="text-center text-xl pb-2">找回密码</p>
        <el-form
          :model="findPassForm.form2"
          :rules="findPassRules"
          class="px-4 py-2"
        >
          <el-form-item prop="resetPass">
            <el-input
              v-model="findPassForm.form2.resetPass"
              placeholder="系统重置密码"
            ></el-input>
          </el-form-item>
          <el-form-item prop="newPass">
            <el-input
              v-model="findPassForm.form2.newPass"
              placeholder="新密码"
              type="password"
            ></el-input>
          </el-form-item>
          <el-form-item prop="checkPass">
            <el-input
              v-model="findPassForm.form2.checkPass"
              placeholder="确认密码"
              type="password"
            ></el-input>
          </el-form-item>
